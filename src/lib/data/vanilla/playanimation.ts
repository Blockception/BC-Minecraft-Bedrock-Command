...
export const playanimation: CommandInfo[] = [
  {
    ...
    parameters: [
      ...
      { text: "next_state", type: ParameterType.string, required: false },
      { text: "blend_out_time", type: ParameterType.float, required: false },
      { text: "stop_expression", type: ParameterType.string, required: false },
