...
export const scoreboard: CommandInfo[] = [
  {
    ...
    parameters: [
      ...
      { text: "displayName", type: ParameterType.string, required: false },
    ],
  },
  {
    name: "scoreboard",
  ...
  },
  {
    ...
    parameters: [
      ...
      { text: "targetName", type: ParameterType.selector, required: true },
      { text: "targetObjective", type: ParameterType.objective, required: true },
